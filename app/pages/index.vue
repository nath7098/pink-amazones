  ...
  <div class="container mx-auto px-4 py-16">
    ...
    <div class="max-w-4xl mx-auto text-center mb-16 mt-6">
      <p class="text-lg md:text-xl leading-relaxed mb-6 text-gray-700">
        Parce qu'aucune femme ne devrait affronter le cancer du sein seule, notre association est là pour informer,
        accompagner et soutenir celles qui en ont besoin.
      </p>
      <p class="text-lg md:text-xl leading-relaxed mb-6 text-gray-700">
        Chaque jour, nous œuvrons pour sensibiliser à l'importance du dépistage, apporter du réconfort aux patientes et
        financer des actions concrètes pour améliorer leur quotidien.
      </p>
      ...
      <template #list>
        <ul class="space-y-4 text-gray-700 mb-8">
          <li class="flex items-start justify-center">
            ...
            <p>Participer et promouvoir des initiatives de prévention et de sensibilisation au dépistage et aux
              problèmes liés au cancer du sein, tant pour les personnes malades que pour leurs proches</p>
          </li>
          ...
          <li class="flex items-start">
            ...
            <p>Partager ses connaissances réseaux pour accompagner au mieux les malades pendant leurs parcours de
              soins</p>
          </li>
          <li class="flex items-start">
            <div class="flex-shrink-0 h-6 w-6 text-pink-500 mr-2">
            ...
            <p>Être un soutien au corps et à l'esprit, pour les malades du cancer, les personnes en rémission, ainsi
              qu'à leurs proches</p>
          </li>
          <li class="flex items-start">
            <div class="flex-shrink-0 h-6 w-6 text-pink-500 mr-2">
              <UIcon name="i-heroicons-check-circle" class="w-6 h-6"/>
    ...
    <div class="text-center max-w-4xl mx-auto mb-16">
      ...
      <div class="flex sm:flex-row flex-col items-center justify-center gap-4 space-y-8">
        <pink-gauge/>
        <pink-members/>
      </div>
    </div>
