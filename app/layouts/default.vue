<template>
  <div>
    <nav
        class="relative flex flex-wrap justify-between items-end px-4 w-full bg-white border-b border-pink-100 shadow-sm py-2">
      <!-- Logo with subtle glow effect -->
      <div class="relative">
        <div class="absolute -inset-1 bg-pink-100 rounded-full blur-md opacity-70"></div>
        <img src="/logo.png" alt="logo"
             class="md:size-[10rem] sm:size-[8rem] size-[5rem] rounded-full object-center relative z-10"/>
      </div>
      ...
      <div class="absolute left-1/2 translate-x-[-50%] top-[.5rem]">
        ...
        <span class="text-primary relative">
          Pink
          <span
              class="absolute -bottom-1 left-0 w-full h-1 bg-primary rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform"></span>
        </span>
          Amazones
        </div>
      </div>
      ...
      >
        <div class="flex flex-col shrink-1 md:flex-row md:gap-x-5 lg:gap-x-8 md:border-0">
          ...
          >
            {{ item.label }}
            <span
                class="absolute bottom-0 left-0 w-full h-0.5 bg-primary rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </ULink>
        </div>
      </div>
    </nav>
      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-4">
            <a href="https://www.facebook.com/profile.php?id=61568564020412" target="_blank"
               class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-pink-400 hover:bg-pink-600 hover:text-white transition-colors">
              <UIcon name="i-uil-facebook-f" class="w-5 h-5"/>
            </a>
            <a href="https://www.instagram.com/pink_amazones/?igsh=NGFzZTE5MHIIZ2J4#" target="_blank"
               class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-pink-400 hover:bg-pink-600 hover:text-white transition-colors">
              <UIcon name="i-uil-instagram" class="w-5 h-5"/>
            </a>
            <a href="mailto:pinkamazones37@gmail.com"
               class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-pink-400 hover:bg-pink-600 hover:text-white transition-colors">
